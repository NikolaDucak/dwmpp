...
static const WMConfig windowManager {
    ...
    .mouseBindings {
        MouseBinding {
            ClickLocation::Client, ModKey, LeftClick, moveFloating, {} },
        MouseBinding {
            ClickLocation::Client, ModKey, RightClick, resizeFloating, {} },
        MouseBinding {
            ClickLocation::Client, ModKey, MiddletClick, resizeFloating, {} },
    },
};
